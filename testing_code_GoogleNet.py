...
from GoogleNet_Module import Inception, InceptionBlock, ConvBlock, AuxiliaryBlock
...
OUTPUT_CSV_ABSOLUTE_PATH = "/Users/abirabh/Documents/DL_Project_Task1/output_GN3.csv"
...
model.load_state_dict(
    torch.load(
        f"{os.getcwd()}/checkpoint_googlenet_final.pth",
